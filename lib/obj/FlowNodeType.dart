...
class SalesFlowNodeType {
  ...
  static const SalesFlowNodeType OTHER_TYPE = SalesFlowNodeType(
      "OTHER_TYPE", "第三方业务", "assets/images/home_icon_trade_report.png", 6);

  static const SalesFlowNodeType HISTORY_OUT_WAREHOUSE_RECEIPT =
  SalesFlowNodeType("HISTORY_OUT_WAREHOUSE_RECEIPT", "历史出库单",
      "assets/images/home_icon_history_out_warehouse_receipt.png", 7);
  static const SalesFlowNodeType HISTORY_TRADE_RECEIPT = SalesFlowNodeType(
      "HISTORY_TRADE_RECEIPT", "历史交易单",
      "assets/images/home_icon_history_trade_receipt.png", 8);
  static const SalesFlowNodeType LOGOUT_FLOW_CARD = SalesFlowNodeType(
      "LOGOUT_FLOW_CARD", "注销流程卡", "assets/images/home_icon_logout_process_card.png", 9);
  static const SalesFlowNodeType INVENTORY_QUERY = SalesFlowNodeType(
      "INVENTORY_QUERY", "库存查询", "assets/images/home_icon_inventory_query.png", 10);
  static const SalesFlowNodeType VIEW_PLAN = SalesFlowNodeType(
      "VIEW_PLAN", "查看计划", "assets/images/home_icon_view_plan.png", 11);
  static const SalesFlowNodeType DATA_STATISTICS = SalesFlowNodeType(
      "DATA_STATISTICS", "数据统计", "assets/images/home_icon_data_statistics.png", 12);
  static const SalesFlowNodeType QUICK_REGISTRATION = SalesFlowNodeType(
      "QUICK_REGISTRATION", "快捷注册", "assets/images/home_icon_quick_registration.png", 13);
  static const SalesFlowNodeType HELP_CENTER = SalesFlowNodeType(
      "HELP_CENTER", "帮助中心", "assets/images/home_icon_help_center.png", 14);
