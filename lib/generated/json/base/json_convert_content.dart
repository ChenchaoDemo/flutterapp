...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<ApiResponseEntitiy>[] is M) {
      return data.map<ApiResponseEntitiy>((Map<String, dynamic> e) =>
          ApiResponseEntitiy.fromJson(e)).toList() as M;
    }
    if (<ApiResponseData>[] is M) {
      return data.map<ApiResponseData>((Map<String, dynamic> e) => ApiResponseData.fromJson(e))
          .toList() as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    (ApiResponseEntitiy).toString(): ApiResponseEntitiy.fromJson,
